...
<NavLink onClick={handle_click} to='/Services' className={({isActive})=>`hover:text-green-500 duration-150 ${isActive?"text-green-500  before:w-2/5":" text-neutral-300 before:w-0 "} cursor-pointer relative hover:before:w-2/5 before:bg-green-500 before:-bottom-2 hover:no-underline`}>Services</NavLink>
<NavLink onClick={handle_click} to='/Portfolio' className={({isActive})=>`hover:text-green-500 duration-150 ${isActive?"text-green-500  before:w-2/5":" text-neutral-300 before:w-0 "} cursor-pointer relative hover:before:w-2/5 before:bg-green-500 before:-bottom-2 hover:no-underline`}>Portfolio</NavLink>
<NavLink onClick={handle_click} to='/Contact' className={({isActive})=>`hover:text-green-500 duration-150 ${isActive?"text-green-500  before:w-2/5":" text-neutral-300 before:w-0 "} cursor-pointer relative hover:before:w-2/5 before:bg-green-500 before:-bottom-2 hover:no-underline`}>Contact</NavLink>
</ul>
    </div>
</>
  )
