...
function Contact() {
  return (
    ...
    <div className='space-y-3'>
        <h3 className='text-white text-xl font-medium tracking-wide relative after:absolute after:w-40 after:mt-1 after:h-0.5 after:top-1/2 after:translate-x-2 after:-translate-y-1/2 after:bg-green-500'>CONTACT</h3>
        ...
        <div className='flex flex-col space-y-6'>
            <div className='flex max-lg:flex-col max-lg:space-x-0 max-lg:space-y-6 space-x-6'>
                ...
                <i className="fa-solid fa-location-dot fa-2x text-green-500 px-3 py-2.5 bgTransparentGreyLight rounded-full"></i>
                 ...
                 <h3 className='text-neutral-600 text-2xl font-bold'>My Address</h3>
                ...
                <i className="fa-solid fa-share-nodes fa-2x text-green-500 px-3 py-2.5 bgTransparentGreyLight rounded-full"></i>
                 ...
                 <h3 className='text-neutral-600 text-2xl font-bold'>Social Profiles</h3>
            ...
            <div className='flex max-lg:flex-col max-lg:space-x-0 max-lg:space-y-6 space-x-6'>
                ...
                <i className="fa-regular fa-envelope fa-2x text-green-500 px-3 py-2.5 bgTransparentGreyLight rounded-full"></i>
                 <div className='flex flex-col space-y-1'>
                 <h3 className='text-neutral-600 text-2xl font-bold'>Email Me</h3>
        ...
        <form  className='bgTransparentGrey p-5 space-y-6 text-lg text-white'>
            <div className='flex max-md:flex-col max-md:space-x-0 max-md:space-y-6 space-x-6'>
                <input type="text" className='w-1/2 max-md:w-full bgTransparentGreyLight py-2 px-3 outline-green-500' placeholder='Name' />
                <input type="email" className='w-1/2 max-md:w-full bgTransparentGreyLight py-2 px-3 outline-green-500' placeholder='E-mail' />
            </div>
            <input type="text" className=' w-full bgTransparentGreyLight py-2 px-3 outline-green-500' placeholder='Subject' />
            <textarea id="text-area" cols="30" className=' w-full bgTransparentGreyLight p-3 outline-green-500' placeholder='Message' rows="10"></textarea>
            <div className='flex justify-center items-center'>
            <button className='px-4 py-2 bg-green-500 hover:bg-green-400 font-semibold rounded-xl'>Submit</button>
            </div>
        </form>
    </section>
    </>
